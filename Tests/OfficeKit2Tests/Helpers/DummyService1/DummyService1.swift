...
final class DummyService1 : UserService, GroupOfUsersService, AuthenticatorService {
	...
	func existingUser(fromUserID uID: Never, propertiesToFetch: Set<UserProperty>, using services: Services) async throws -> DummyUser1? {
	}
