...
final class LDAPSearchQueryTests : XCTestCase {
	...
	func testAttributeDescriptionInstantiation1() {
		let attributeDescription = LDAPAttributeDescription(rawValue: "2.5.4.0")
	...
	func testAttributeDescriptionInstantiation2() {
		let attributeDescription = LDAPAttributeDescription(rawValue: "cn;lang-de;lang-en")
	...
	func testAttributeDescriptionInstantiation3() {
		...
		let attributeDescriptionRef = LDAPAttributeDescription(rawValue: "owner")
		XCTAssertEqual(attributeDescription, attributeDescriptionRef)
	}
