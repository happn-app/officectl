...
public struct GoogleServiceConfig : OfficeKitServiceConfig {
	...
	public init(globalConfig: GlobalConfig, providerId pId: String, serviceId id: String, serviceName name: String, connectorSettings c: GoogleJWTConnector.Settings, primaryDomains d: Set<String>) {
		global = globalConfig
