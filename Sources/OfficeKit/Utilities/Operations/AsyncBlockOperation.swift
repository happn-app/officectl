...
See `addAsyncBlock(startHandler:)` in the OperationQueue extension for more
information. */
...
public extension OperationQueue {
	...
	Here’s how it works:
	- The operation starts, calling the block you give in argument. You should
	start your your work there. You can start an async work, indeed.
	- When your block is called, it is given another block (the stop handler).
	You have to call this stop handler when your work is done (whether it ended
