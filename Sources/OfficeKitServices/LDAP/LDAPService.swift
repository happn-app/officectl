...
public final class LDAPService : UserService {
	...
	public typealias UserType = LDAPUser
	...
	public func shortDescription(fromUser user: LDAPUser) -> String {
	...
	public func json(fromUser user: LDAPUser) throws -> JSON {
	...
	public func existingUser(fromID uID: LDAPDistinguishedName, propertiesToFetch: Set<UserProperty>?, using services: Services) async throws -> LDAPUser? {
	...
	public func existingUser(fromPersistentID pID: Never, propertiesToFetch: Set<UserProperty>?, using services: Services) async throws -> LDAPUser? {
	}
	
	public func listAllUsers(includeSuspended: Bool, propertiesToFetch: Set<UserProperty>?, using services: Services) async throws -> [LDAPUser] {
		try await connector.connectIfNeeded()
		return try await connector.performLDAPCommunication{ ldap in
			throw Err.__notImplemented
		}
	...
	public func createUser(_ user: LDAPUser, using services: Services) async throws -> LDAPUser {
		try await connector.connectIfNeeded()
		return try await connector.performLDAPCommunication{ ldap in
			throw Err.__notImplemented
		}
	...
	public func updateUser(_ user: LDAPUser, propertiesToUpdate: Set<UserProperty>, using services: Services) async throws -> LDAPUser {
		try await connector.connectIfNeeded()
		return try await connector.performLDAPCommunication{ ldap in
			throw Err.__notImplemented
		}
	...
	public func deleteUser(_ user: LDAPUser, using services: Services) async throws {
		try await connector.connectIfNeeded()
		return try await connector.performLDAPCommunication{ ldap in
			throw Err.__notImplemented
		}
	...
	public func changePassword(of user: LDAPUser, to newPassword: String, using services: Services) async throws {
		try await connector.connectIfNeeded()
		return try await connector.performLDAPCommunication{ ldap in
			throw Err.__notImplemented
		}
