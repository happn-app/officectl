...
class User : CustomStringConvertible, Hashable, Equatable {
	...
	func accessToken(forScopes scopes: Set<String>, withSuperuser superuser: NSNull, forceRegeneration: Bool = false) throws -> (String, Date) {
		throw NSError(domain: "nope", code: 1, userInfo: nil)
