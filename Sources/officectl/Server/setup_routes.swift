...
func setup_routes(_ router: Router) throws {
	...
	router.get("password-reset",  User.parameter, use: resetPasswordController.showResetPage)
	router.post("password-reset", User.parameter, use: resetPasswordController.resetPassword)
}
