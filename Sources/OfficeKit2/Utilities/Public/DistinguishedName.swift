...
public struct DistinguishedName : Sendable {
	
	public static func +(_ left: DistinguishedName, _ right: DistinguishedName) -> DistinguishedName {
		return DistinguishedName(values: left.values + right.values)
	}
	...
	public init(uid: String, baseDN: DistinguishedName) {
	...
	public func relativeDistinguishedName(for key: String) -> DistinguishedName {
		return DistinguishedName(values: values.filter{ $0.key == key })
	}
	...
	public func relativeTrailingDistinguishedName(for key: String) -> DistinguishedName {
		var foundEnd = false
		return DistinguishedName(values: values.reversed().filter{
	...
	public var dc: DistinguishedName {
...
extension DistinguishedName : Hashable {
	...
	public static func ==(lhs: DistinguishedName, rhs: DistinguishedName) -> Bool {
...
extension DistinguishedName : Codable {
